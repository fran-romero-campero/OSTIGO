...
ostta_v3_go_annotation <- rbind(ostta_v2_go_annotation,lipid.genes.df,chromatin.genes.df)
...
makeOrgPackage(go=ostta.annoation.v4,
               version = "4.1",
...
install.packages("./org.Otauriv4.eg.db/", repos=NULL, type = "source")
