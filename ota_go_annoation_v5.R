...
## Lipid Genes
lipid.metabolism.genes <- read.table(file="manual_expansion/lipid_genes.tsv",header=F,as.is = T)[[1]]
...
ostta_v3_go_annotation <- rbind(ostta_v2_go_annotation,chromatin.genes.df)#,lipid.genes.df,chromatin.genes.df)
...
makeOrgPackage(go=ostta.annoation.v5,
               version = "5.1",
...
install.packages("./org.Otauriv5.eg.db/", repos=NULL, type = "source")
